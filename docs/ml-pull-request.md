...
Opening a pull request will trigger a[workflow](../.github/workflows/myllmops-run-tests.yml) 
...
Links:
* [Staging model in UC](https://adb-xxxx.xx.azuredatabricks.net/explore/data/models/staging/myllmops/myllmops-model)
* [Prod model in UC](https://adb-xxxx.xx.azuredatabricks.net/explore/data/models/prod/myllmops/myllmops-model)
. 
