...
git add README.md docs .gitignore myllmops/resources/README.md
...
If you want to use different catalog names, please update the target names declared in the[myllmops/databricks.yml](../myllmops/databricks.yml) file.
...
Follow the instructions in [myllmops/resources/README.md](../myllmops/resources/README.md) to deploy ML resources
and production jobs.
...
[ML resource config guide](../myllmops/resources/README.md)  to propose, test, and deploy
